...
export class QuestionControllerService {
     ...
     * @throws ApiError
     */
    public static delMyErrorSubmitUsingPost(
        deleteRequest: DeleteRequest,
    ): CancelablePromise<BaseResponse_boolean_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
    ...
    /**
     * listMySubmitQuestionByPage
     * @param questionSubmitQueryRequest questionSubmitQueryRequest
     * @returns BaseResponse_Page_QuestionSubmit_ OK
     * @returns any Created
     * @throws ApiError
     */
    public static listMySubmitQuestionByPageUsingPost(
        questionSubmitQueryRequest: QuestionSubmitQueryRequest,
    ): CancelablePromise<BaseResponse_Page_QuestionSubmit_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/submit/list/my/page',
            body: questionSubmitQueryRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
    ...
    /**
     * listSubmitQuestionByPage
     * @param questionSubmitQueryRequest questionSubmitQueryRequest
     * @returns BaseResponse_Page_QuestionSubmitVO_ OK
     * @returns any Created
     * @throws ApiError
     */
    public static listSubmitQuestionByPageUsingPost(
        questionSubmitQueryRequest: QuestionSubmitQueryRequest,
     ...
     * @throws ApiError
     */
    public static retryMyErrorSubmitUsingPost(
        deleteRequest: DeleteRequest,
    ): CancelablePromise<BaseResponse_boolean_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/submit/retry',
            body: deleteRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
