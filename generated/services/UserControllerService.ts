...
import type { UserPwdUpdateMyRequest } from '../models/UserPwdUpdateMyRequest';
...
export class UserControllerService {
    ...
    /**
     * updatePwdMyUser
     * @param userPwdUpdateMyRequest userPwdUpdateMyRequest
     * @returns BaseResponse_boolean_ OK
     * @returns any Created
     * @throws ApiError
     */
    public static updatePwdMyUserUsingPost(
        userPwdUpdateMyRequest: UserPwdUpdateMyRequest,
    ): CancelablePromise<BaseResponse_boolean_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/user/update/myPwd',
            body: userPwdUpdateMyRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
